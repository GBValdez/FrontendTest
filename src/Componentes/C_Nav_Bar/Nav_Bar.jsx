...
import Boton_Dir from "../Botones/Boton_A/Boton_Dir"
import "./Barra_Nav.css"
function Nav_Bar(){
        return(
            <header>
                <nav className="Barra-Navegador">
                    <div className="Logo">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="Icono_Book" viewBox="0 0 16 16">
